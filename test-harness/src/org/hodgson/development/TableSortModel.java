 ...
 * three values: {NOT_SORTED, ASCENDING, DESCENDING} (then back to NOT_SORTED again).
 * <li>
 * SHIFT-mouse-click: Clears the sorting status of all other columns and cycles the sorting status of the column through
 * the same three values, in the opposite order: {NOT_SORTED, DESCENDING, ASCENDING}.
 * <li>
 * CONTROL-mouse-click and CONTROL-SHIFT-mouse-click: as above except that the changes to the column do not cancel the
 * statuses of columns that are already sorting - giving a way to initiate a compound sort.
 * </ul>
...
public class TableSortModel extends AbstractTableModel
{
	...
	private class TableModelHandler implements TableModelListener
	{
		public void tableChanged(TableModelEvent e)
		{
					...
					&& modelToView != null)
			{
				...
				fireTableChanged(new TableModelEvent(TableSortModel.this,
	...
	private static final long serialVersionUID = 3599057389110113381L;
	...
	public TableSortModel(TableModel tableModel)
	{
		this();
		setTableModel(tableModel);
	}

	public TableSortModel(TableModel tableModel, JTableHeader tableHeader)
	{
		this();
